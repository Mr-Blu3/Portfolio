          ...
          <div class="row">
              <div>
                  <h3 class="page-title">
                      <?php
                      if( is_home() ){
                        _e( ( get_theme_mod('Portfolio') ) ? get_theme_mod('portfolio') : 'Portfolio'  , 'shapely' );
                      }
                      else if( is_search() ){
                        _e( 'Search'  , 'shapely' );
                      }
                        ...
                        echo ( is_singular('jetpack-portfolio') ) ? __('Portfolio', 'shapely') : "<center>".get_the_title()."</center>";
                      }?>
                  </h3>
              </div>
