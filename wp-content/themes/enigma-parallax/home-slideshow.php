				...
				<div class="carousel-caption">
					...
					<div class="carousel-text">
						...
						if($wl_theme_options['slide_btn_text_1']!='') { ?>
							<a class="enigma_blog_read_btn animated bounceInUp" href="<?php if($wl_theme_options['slide_btn_link_1']!='') { echo esc_url($wl_theme_options['slide_btn_link_1']); } ?>"><?php echo esc_attr($wl_theme_options['slide_btn_text_1']); ?></a>
						<?php } ?>
					</div>
					<?php } ?>
				</div>
			...
			<div class="container">
				<div class="carousel-caption">			
					...
					<div class="carousel-text">
						...
						<a class="enigma_blog_read_btn animated bounceInUp" href="<?php if($wl_theme_options['slide_btn_link_2']!='') { echo esc_url($wl_theme_options['slide_btn_link_2']); } ?>"><?php echo esc_attr($wl_theme_options['slide_btn_text_2']); ?></a>
						<?php } ?>
					</div>
					<?php } ?>
				</div>
				...
				<div class="carousel-caption">
					...
					<div class="carousel-text">
						...
						if($wl_theme_options['slide_btn_text_3']!='') { ?>
							<a class="enigma_blog_read_btn animated bounceInUp" href="<?php if($wl_theme_options['slide_btn_link_3']!='') { echo esc_url($wl_theme_options['slide_btn_link_3']); } ?>"><?php echo esc_attr($wl_theme_options['slide_btn_text_3']); ?></a>
						  <?php } ?>
					</div>
					<?php } ?>
				</div>
