...
abstract class Responsive_Portfolio_Gallery_Shortcodes {
	...
	public function content($columns, $categories, $default_view){
		...
		$this->portfolio_filter_output($filter_cats);
		//echo $portfolio_filter;
		echo $portfolio_list;
		$this->include_javascript($columns, $default_view);
	} 
			...
			jQuery(document).ready(
				function(){
					...
					imagesLoaded( 
						...
						function( instance ) {
							jQuery("span.2-col-<?php echo $default_view; ?>").trigger('click');
